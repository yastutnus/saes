...
message.guild.roles.create({ data: { name: '👑 ・King Of Eternal' }, reason: 'ayn' }).then(role => {
...
message.guild.roles.create({ data: {name : '👑 ・ Owner Of Eternal' } , reason: 'ayn'}).then(role => {
...
message.guild.roles.create({ data: { name: '🐲・Dragon Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#2efef7'))
message.guild.roles.create({ data: { name: '🌟 ・ Manager Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#f4fa58'))
message.guild.roles.create({ data: { name: '💣 ・Master Mod. Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#955aab'))
message.guild.roles.create({ data: { name: 'Köle' }, reason: 'ayn' }).then(s => s.setColor('#2e9afe'))
message.guild.roles.create({ data: { name: '💫・Experienced Mod. Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#00ff40'))
message.guild.roles.create({ data: { name: '⚡・Moderator Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#e77e2e'))
message.guild.roles.create({ data: { name: '🌠・Register Mod. Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#ffffff'))
message.guild.roles.create({ data: { name: '🌩 ・Testing Mod. Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#955aab'))
message.guild.roles.create({ data: { name: 'Mute Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#ffff00'))
message.guild.roles.create({ data: { name: '📙・Guide Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '☢・Guest Of Honor' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🌀・Family Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '💎・Special Member Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🥂・Sponsor Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🎨・Designer Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '⭐🎉・Ultra Supporter Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🤝・Partner Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🐲・Dragon Supporter Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🎉・Supporter Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🔥・Member Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '👤・Unregistered Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
message.guild.roles.create({ data: { name: '🔑・Bots Of Eternal' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
...
message.guild.roles.create({ data: { name: '✨・ Eternal Moderation Crew' }, reason: 'ayn' }).then(s => s.setColor('#58fa58'))
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['sunucu-kur-ultra-gelişmiş'],
  permLevel: 0
}

exports.help = {
  name: 'sunucu-kur-ultra-gelişmiş'
